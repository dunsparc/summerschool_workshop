...
agent = AgentClient(
   model=model,
   system_prompt="You are a friendly virtual assistant. Use the 'bloom_tool' to get the bloom level of each question in the file and make a question with the same bloom level in the topic provided by the user",  # Replace with your system prompt
   tools = [bloom_tool]
).create_agent()
